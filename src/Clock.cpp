...
void Clock::setNextFrequency() { this->freq = (Frequency)((this->freq + 1) % DelimiterAmountOfFrequencies); }
...
void Clock::getTimeString(char *buffer) { sprintf(buffer, "%02d:%02d", (int)(this->getHours()), (int)(this->getMinutes())); }
