#include<Log.h>
  ...
  void log(LogLevel l, int msg) {
    if (LOG_LEVEL <= l) {
      switch (l) {
        case Debug: printf("DEBUG: %d\n", msg); break;
        case Info: printf("INFO: %d\n", msg); break;
        case Warn: printf("WARN: %d\n", msg); break;
  ...
  void log(LogLevel l, const char *msg, int i) {
    if (LOG_LEVEL <= l) {
      switch (l) {
        case Debug: printf("DEBUG: %s %d\n", msg, i); break;
        case Info: printf("INFO: %s %d\n", msg, i); break;
        case Warn: printf("WARN: %s %d\n", msg, i); break;
        case Error: printf("ERROR: %s %d\n", msg, i); break;
      }
    }
  }
